...
function site_ibej_widgets_init() {
    ...
    register_sidebar( array(
        'name' => __( 'Post Recentes', 'site_ibej' ),
        'id' => 'post_recentes',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widgettitle">',
...
if ( ! function_exists( 'site_ibej_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'lightbox', get_template_directory_uri() . '/assets/js/lightbox.min.js', false, null, true);

    wp_deregister_script( 'owlcarousel' );
    wp_enqueue_script( 'owlcarousel', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', false, null, true);
    ...
    wp_enqueue_script( 'typed', get_template_directory_uri() . '/assets/js/typed.js', false, null, true);
    ...
    wp_enqueue_style( 'style', 'https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600', false, null, 'all');
    ...
    wp_enqueue_style( 'fontawesomeall', get_template_directory_uri() . '/assets/css/fontawesome-all.min.css', false, null, 'all');

    wp_deregister_style( 'lightbox' );
    wp_enqueue_style( 'lightbox', get_template_directory_uri() . '/assets/css/lightbox.min.css', false, null, 'all');

    wp_deregister_style( 'owlcarousel' );
    wp_enqueue_style( 'owlcarousel', get_template_directory_uri() . '/assets/css/owl.carousel.min.css', false, null, 'all');
