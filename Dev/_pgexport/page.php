<?php get_header(); ?>
        ...
        <header id="header" class="header">
            ...
            <div class="bg-img bg-overlay page-title section-padding" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/414629-PD6SKX-817.jpg');<?php if($image_attributes) echo 'background-image:url(\''.$image_attributes[0].'\')' ?>">
                <div class="container">
